        ...
        <div className="flex flex-col items-center sm:items-start gap-4 w-full sm:w-1/3">
          ...
          <div className="text-center sm:text-left">
            <p className="text-2xl font-bold">
              {display(selectedStudent.first_name)} {display(selectedStudent.last_name)}
            </p>
            <p className="text-muted-foreground">{display(selectedStudent.student_email_id)}</p>
            <p className="text-muted-foreground">{display(selectedStudent.student_mobile_number)}</p>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Leaving Certificate No.</p>
                <p>{display(selectedStudent.leaving_certificate_number)}</p>
              </div>
              <div>
